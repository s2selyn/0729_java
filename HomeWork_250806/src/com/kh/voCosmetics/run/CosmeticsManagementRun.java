...
public class CosmeticsManagementRun {
	...
	public static void main(String[] args) {
		...
		cosmeticItem.type = sc.nextLine();
		
		System.out.print("화장품의 색상은 무엇인가요? > ");
		cosmeticItem.color = sc.nextLine();
		
		System.out.print("브랜드 또는 제조사를 알려주세요 > ");
		cosmeticItem.brand = sc.nextLine();
		
		System.out.print("어떤 피부 타입에 추천하나요? > ");
		cosmeticItem.skinType = sc.nextLine();
		
		System.out.print("남은 사용기간은 며칠인가요? > ");
		cosmeticItem.expirationDays = sc.nextInt();
		...
		while(!exit) {
			...
			System.out.println();
			System.out.println("==============================");
			System.out.println("종류 : " + cosmeticItem.type);
			System.out.println("색상 : " + cosmeticItem.color);
			System.out.println(cosmeticItem.brand + "의 제품입니다.");
			System.out.println(cosmeticItem.skinType + " 타입의 피부에 추천하는 제품입니다!");
			System.out.println(cosmeticItem.expirationDays + "일이 지나기 전에 사용하세요.");
			System.out.println("==============================");
			System.out.println();
